...
<div class="container mx-auto px-4 lg:px-8 py-8">
    ...
    <div class="flex flex-col lg:flex-row gap-8">
        ...
        <div class="w-full lg:w-3/4">
            <h1 class="text-3xl font-bold mb-6">Packing List</h1>

            <!-- Featured Image -->
            <div class="mb-8">
                <img src="assets/packinglist.png" alt="Nepal Visa" class="w-full h-auto rounded-lg shadow-md mb-6">
            </div>

            <div class="space-y-6 text-gray-800 leading-relaxed text-[16px]">
                <h2 class="text-2xl font-bold mb-4 text-blue-700">Packing List for Trekking in Himalayas</h2>

                <p class="bg-yellow-100 border-l-4 border-yellow-500 p-4 italic">
                ...
                <!-- Head & Hand Gear -->
                <div class="mb-6">
                    <h3 class="text-xl font-semibold text-blue-600 mb-3">Head & Hand Gear</h3>
                ...
                <!-- Footwear -->
                <div class="mb-6">
                    <h3 class="text-xl font-semibold text-blue-600 mb-3">Footwear</h3>
                    <div class="bg-white shadow rounded-lg p-4 space-y-2">
                        <ul class="list-disc list-inside pl-2">
                ...
                <!-- Clothing -->
                <div class="mb-6">
                    <h3 class="text-xl font-semibold text-blue-600 mb-3">Clothing</h3>
                    <div class="bg-white shadow rounded-lg p-4 space-y-2">
                        <ul class="list-disc list-inside pl-2">
                ...
                <!-- Accessories -->
                <div class="mb-6">
                    <h3 class="text-xl font-semibold text-blue-600 mb-3">Accessories</h3>
                    <div class="bg-white shadow rounded-lg p-4 space-y-2">
                        <ul class="list-disc list-inside pl-2">
                ...
                <!-- Additional Gear -->
                <div class="mb-6">
                    <h3 class="text-xl font-semibold text-blue-600 mb-3">Additional Gear</h3>
                    <div class="bg-white shadow rounded-lg p-4 space-y-2">
                        <ul class="list-disc list-inside pl-2">
                ...
                <!-- Medical & Personal -->
                <div class="mb-6">
                    <h3 class="text-xl font-semibold text-blue-600 mb-3">Medical & Personal Items</h3>
                    <div class="bg-white shadow rounded-lg p-4 space-y-2">
                        <ul class="list-disc list-inside pl-2">
                ...
                <!-- Travel Items -->
                <div class="mb-6">
                    <h3 class="text-xl font-semibold text-blue-600 mb-3">Travel Items</h3>
                    <div class="bg-white shadow rounded-lg p-4 space-y-2">
                        <ul class="list-disc list-inside pl-2">
                ...
                <div class="mb-6">
                    <h3 class="text-xl font-semibold text-blue-600 mb-3">Climbing Gear (If Applicable)</h3>
                    <div class="bg-white shadow rounded-lg p-4 space-y-2">
                        <ul class="list-disc list-inside pl-2">
                            <li>Ice Axe</li>
                            <li>Crampons</li>
