...
$travelwithus = mysqli_query($con, "SELECT * FROM whytravelwithus ORDER BY id DESC;
");
$row = mysqli_fetch_assoc($travelwithus);
?>
...
<div class="container mx-auto px-4 lg:px-8 py-8">
    ...
    <div class="flex flex-col lg:flex-row gap-8">
        ...
        <div class="w-full lg:w-3/4">
            <h1 class="text-3xl font-bold mb-6">Why Travel With Us</h1>

            <!-- Featured Image -->
            <div class="mb-8">
                <img src="admin/<?php echo $row['image_path']; ?>" alt="Nepal Visa"
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <ul class="space-y-3">
                        <li class="border-b pb-3">
                            <a href="#" class="text-blue-600 hover:text-blue-800 transition-colors">Who we are</a>
                        </li>
                        <li class="border-b pb-3">
                            <a href="#" class="text-blue-600 hover:text-blue-800 transition-colors">Why Travel With
                                Us</a>
                        </li>
                        <li class="border-b pb-3">
                            <a href="#" class="text-blue-600 hover:text-blue-800 transition-colors">Our Team</a>
                        </li>
